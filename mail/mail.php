...
if(isset($_POST['email'])) {
	...
	$transport = Swift_SmtpTransport::newInstance('mail.ireneyeyuan.me', 25, 'tls' )
	  ->setUsername('contactform@ireneyeyuan.me')
	  ->setPassword('scum2014')
	  ;
	...
	$message = Swift_Message::newInstance('A message from ireneyeyuan.me')
	  ->setFrom(array($_POST['email'] => $_POST['name']))
	  ->setTo(array('ireneyeyuan@gmail.com' => 'Irene Ye Yuan'))->setBody($messageText);
//                           ^                    ^
